...
This repo is a student project in a software engineering course. Exit Zero is a structured learning framework that delivers tasks and supports their progress through a small CLI tool (`e0`) installed in `.exit0/`.
